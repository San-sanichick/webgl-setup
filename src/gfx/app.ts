...
export default class App2D
{
    ...
    public async run()
    {
        ...
        // const commands = [parseSVG.parseSVG("M 136.3 8.1 C 131.3 10.2 130.1 13.2 132 19.3 C 133.1 23 133 23.6 131.5 24.5 C 121.9 30.1 115.8 38.4 114.5 47.5 C 114.1 50.2 113.4 53.2 112.9 54.2 C 112.3 55.3 112.5 56 113.5 56.4 C 114.3 56.7 115 57.9 115 59 C 115 60.2 115.6 61.7 116.3 62.4 C 118.3 64.4 124.3 67.4 125.8 67.2 C 127.3 66.9 127.4 70.4 126 73.1 C 125.1 74.7 125.7 75.8 129.5 79.7 C 133.6 84 134.1 85 133.9 88.5 C 133.7 90.8 134 93.1 134.4 93.8 S 134.9 95.7 134.6 96.5 S 134.5 98.2 134.9 98.5 C 136.9 99.6 137.2 106.3 135.4 110.1 C 133.9 113.5 133.4 113.8 130.9 113.3 C 126.9 112.5 125 114.3 125.7 118.5 C 126.2 121.4 125.7 122.4 122.4 126 C 118.5 130.1 118.5 130.1 115 128.7 C 113.1 127.9 107.2 125.9 102 124.4 S 92 120.9 91.4 120.1 C 90.7 119.2 90 116.2 89.8 113.3 C 89.5 109.5 88.7 107.3 86.9 105.4 C 84.8 103.1 83.9 102.9 79.8 103.4 C 75.4 103.9 75 103.7 74.9 101.7 C 74.8 99.6 74.8 99.6 74.1 101.8 C 73.7 103.3 71.8 105 69.1 106.3 C 63.9 108.9 61.3 114.1 63 118.6 C 63.6 120 64 122.2 64 123.4 S 65.7 127.5 67.8 129.7 C 70.7 132.8 72.7 133.9 77.2 134.9 L 82.9 136.1 L 82.3 144.8 C 82 149.6 81.2 155.7 80.4 158.4 S 79 164.4 79 165.7 V 168 H 193 L 190 161.9 C 187.8 157.7 187 154.7 187.2 152.2 C 187.5 149 187.9 148.5 191 147.7 C 192.9 147.2 195.4 145.7 196.7 144.4 L 198.9 142 H 195.9 C 194.3 142 191.3 142.7 189.3 143.5 C 187.3 144.4 185.4 144.7 185 144.3 C 184.2 143.3 181 126.7 180.6 121.7 C 180.3 118.4 180.5 118 182.1 118.5 C 184.4 119.3 184.4 119.3 182 114.5 C 180 110.6 179.6 105.7 180.9 101 C 181.6 98.6 181.6 98.6 183 101.9 C 184.2 104.8 184.5 105 185 103.4 C 185.6 101.8 186 102.1 187.9 105.5 C 189.9 109.1 190 109.2 189.5 106.5 C 188.9 103.7 188.9 103.6 190.8 105.3 C 192.6 107 192.7 106.7 192.4 90.3 C 191.8 61.1 190.4 50.6 185.5 39 C 184.2 36 182.9 31.8 182.5 29.8 C 181.7 24.8 174.1 16.4 169 14.9 C 166.4 14.1 164.3 14.1 162.3 14.7 C 158.9 15.9 154.9 14.8 150.2 11.3 C 144.1 6.7 141 6 136.3 8.1 M 147.4 87.9 C 148.9 90.7 148.8 90.9 146.5 92.4 L 144 94 V 90.2 C 144 86.8 144.6 85 145.6 85 C 145.8 85 146.6 86.3 147.4 87.9 Z")];
        ...
        const commands = [parseSVG.parseSVG("M 10 0 C 4.475 0 0 4.3588 0 9.7403 C 0 14.0504 2.8625 17.6908 6.8375 18.9814 C 7.3375 19.0666 7.525 18.7744 7.525 18.5187 C 7.525 18.2874 7.5125 17.5203 7.5125 16.7046 C 5 17.1551 4.35 16.108 4.15 15.5601 C 4.0375 15.2801 3.55 14.4156 3.125 14.1843 C 2.775 14.0017 2.275 13.5512 3.1125 13.539 C 3.9 13.5268 4.4625 14.2452 4.65 14.5374 C 5.55 16.0106 6.9875 15.5966 7.5625 15.341 C 7.65 14.7078 7.9125 14.2817 8.2 14.0382 C 5.975 13.7947 3.65 12.9546 3.65 9.2289 C 3.65 8.1697 4.0375 7.293 4.675 6.6112 C 4.575 6.3677 4.225 5.3693 4.775 4.0301 C 4.775 4.0301 5.6125 3.7744 7.525 5.0284 C 8.325 4.8093 9.175 4.6997 10.025 4.6997 C 10.875 4.6997 11.725 4.8093 12.525 5.0284 C 14.4375 3.7622 15.275 4.0301 15.275 4.0301 C 15.825 5.3693 15.475 6.3677 15.375 6.6112 C 16.0125 7.293 16.4 8.1575 16.4 9.2289 C 16.4 12.9668 14.0625 13.7947 11.8375 14.0382 C 12.2 14.3426 12.5125 14.927 12.5125 15.8401 C 12.5125 17.1429 12.5 18.19 12.5 18.5187 C 12.5 18.7744 12.6875 19.0788 13.1875 18.9814 C 15.1727 18.3286 16.8977 17.0859 18.1198 15.4282 C 19.3419 13.7704 19.9995 11.7811 20 9.7403 C 20 4.3588 15.525 0 10 0 Z")];
